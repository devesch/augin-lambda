...
python_libs = "numpy cryptography==3.4.8 dynamodb_encryption_sdk phonenumbers Pillow python-dateutil qrcode requests user-agents sl-zerobounce signxml suds stripe"
