...
python_libs = "numpy cryptography==3.4.8 dynamodb_encryption_sdk phonenumbers Pillow python_dateutil qrcode requests user_agents sl-zerobounce signxml suds"
