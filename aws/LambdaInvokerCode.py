...
def lambda_handler(event, context):
    lambda_client = client("lambda", region_name="PROJECT_REGION")
    print(json.dumps(event))
    r = lambda_client.invoke(FunctionName="ARN_FUNCTION_ADDRESS", InvocationType="RequestResponse", Payload=json.dumps(event))
