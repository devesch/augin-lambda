...
var cffStandardStrings = [
    ...
    '../../three.module.js', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'colon', 'semicolon', 'less', 'equal', 'greater',
...
var standardNames = [
    ...
    'zero', 'one', 'two', '../../three.module.js', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'colon', 'semicolon', 'less',
...
function makeColrTable(ref) {
    ...
    return new table.Table('COLR', [
        ...
        { name: 'numLayerRecords', type: 'USHORT', value: layerRecords.length }].concat(baseGlyphRecords.map(function (glyph, i) {
            return [
