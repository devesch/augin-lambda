import { Vector2, Vector3, Vector4, Quaternion, Matrix4, Spherical, Box3, Sphere, Raycaster, MathUtils } from '../threejs/three.module.js';
...
export class CameraControls extends EventDispatcher {
    ...
    constructor(camera, domElement) {
        ...
        this._focalOffsetVelocity = new Vector3();
        ...
        this._dollyInternal = (delta, x, y) => {
            ...
            const clampedDistance = MathUtils.clamp(distance, this.minDistance, this.maxDistance);
        ...
        const onPointerDown = (event) => {
            ...
            if (mouseButton !== null) {
                ...
                this._currentMouseButton = mouseButton;
            }
        ...
        const onMouseWheel = (event) => {
            ...
            this._currentMouseButton = void 0;
    ...
    move(x, y, z, enableTransition = false) {
        this._camera.updateMatrix();
        _xColumn.setFromMatrixColumn(this._camera.matrix, 0);
        _yColumn.setFromMatrixColumn(this._camera.matrix, 1);
        ...
        _xColumn.multiplyScalar(x);
        _yColumn.multiplyScalar(-y);
        _zColumn.multiplyScalar(-z);
        const offset = _v3A.copy(_xColumn).add(_yColumn).add(_zColumn);
        const to = _v3B.copy(this._targetEnd).add(offset);
        return this.moveTo(to.x, to.y, to.z, enableTransition);
    }
    /**
