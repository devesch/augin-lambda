...
class Dynamo:
    ...
    def get_used_coupon(self, coupon_code, user_id):
    ...
    def query_paginated_all_cart_abandonment(self, last_evaluated_key=None, limit=10):
        key_schema = {"entity": {"S": ""}, "sk": {"S": ""}, "created_at": {"S": ""}, "pk": {"S": ""}}
        query, last_evaluated_key = self.execute_paginated_query({"TableName": lambda_constants["table_project"], "IndexName": "entity-created_at-index", "KeyConditionExpression": "#bef90 = :bef90", "ExpressionAttributeNames": {"#bef90": "entity"}, "ExpressionAttributeValues": {":bef90": {"S": "cart_abandonment"}}}, limit, last_evaluated_key, key_schema)
        return self.execute_batch_get_item(query), last_evaluated_key
    ...
    def get_user_notification(self, user_id, notification_id):
        return self.execute_get_item({"TableName": lambda_constants["table_project"], "Key": {"pk": {"S": "user#" + user_id}, "sk": {"S": "notification#" + notification_id}}})

    def query_user_notifications(self, user_id):
        return self.execute_query({"TableName": lambda_constants["table_project"], "KeyConditionExpression": "#bef90 = :bef90 And begins_with(#bef91, :bef91)", "ExpressionAttributeNames": {"#bef90": "pk", "#bef91": "sk"}, "ExpressionAttributeValues": {":bef90": {"S": "user#" + user_id}, ":bef91": {"S": "notification#"}}})
    ...
    def get_user_device(self, user_id, device_id):
        return self.execute_get_item({"TableName": lambda_constants["table_project"], "Key": {"pk": {"S": "user#" + user_id}, "sk": {"S": "device#" + device_id}}})
    ...
    ### PRODUCTS ###
    def query_paginated_all_products(self, last_evaluated_key=None, limit=10):
        key_schema = {"entity": {"S": ""}, "sk": {"S": ""}, "created_at": {"S": ""}, "pk": {"S": ""}}
        query, last_evaluated_key = self.execute_paginated_query({"TableName": lambda_constants["table_project"], "IndexName": "entity-created_at-index", "KeyConditionExpression": "#bef90 = :bef90", "ExpressionAttributeNames": {"#bef90": "entity"}, "ExpressionAttributeValues": {":bef90": {"S": "product"}}}, limit, last_evaluated_key, key_schema)
        return self.execute_batch_get_item(query), last_evaluated_key
